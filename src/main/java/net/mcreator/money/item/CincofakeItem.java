...
public class CincofakeItem extends MoneyModElements.ModElement {
	@ObjectHolder("money:cincofake")
	public static final Item block = null;

	public CincofakeItem(MoneyModElements instance) {
		super(instance, 5);
	}
