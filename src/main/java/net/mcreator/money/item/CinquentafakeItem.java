...
public class CinquentafakeItem extends MoneyModElements.ModElement {
	@ObjectHolder("money:cinquentafake")
	public static final Item block = null;

	public CinquentafakeItem(MoneyModElements instance) {
		super(instance, 8);
	}
