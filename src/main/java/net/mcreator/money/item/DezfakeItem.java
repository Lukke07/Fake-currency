...
public class DezfakeItem extends MoneyModElements.ModElement {
	@ObjectHolder("money:dezfake")
	public static final Item block = null;

	public DezfakeItem(MoneyModElements instance) {
		super(instance, 6);
	}
