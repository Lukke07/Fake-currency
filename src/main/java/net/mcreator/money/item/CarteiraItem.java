...
import net.mcreator.money.gui.CarteiraGuiGuiWindow;
import net.mcreator.money.gui.CarteiraGuiGui;
...
public class CarteiraItem extends MoneyModElements.ModElement {
	@ObjectHolder("money:carteira")
	public static final Item block = null;

	public CarteiraItem(MoneyModElements instance) {
		super(instance, 71);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof CarteiraGuiGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Carteira");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new CarteiraGuiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
