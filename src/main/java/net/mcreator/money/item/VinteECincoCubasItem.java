...
public class VinteECincoCubasItem extends MoneyModElements.ModElement {
	@ObjectHolder("money:vinte_e_cinco_cubas")
	public static final Item block = null;

	public VinteECincoCubasItem(MoneyModElements instance) {
		super(instance, 68);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("vinte_e_cinco_cubas");
		}
