...
public class CincoCubasItem extends MoneyModElements.ModElement {
	@ObjectHolder("money:cinco_cubas")
	public static final Item block = null;

	public CincoCubasItem(MoneyModElements instance) {
		super(instance, 70);
	}
