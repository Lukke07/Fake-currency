...
public class DoisfakeItem extends MoneyModElements.ModElement {
	@ObjectHolder("money:doisfake")
	public static final Item block = null;

	public DoisfakeItem(MoneyModElements instance) {
		super(instance, 4);
	}
